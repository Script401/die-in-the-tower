...
function turnoJogador() {
    iniTurnoAc[0] > 9 && iniTurnoAc[0] < 13 ? aprIni - enfIni < -10 ? iniTurnoAc[0] = 15 : iniTurnoAc[0] = 0 : aprIni - enfIni < -10 ? iniTurnoAc[0] = 15 : iniTurnoAc[0] = Math.floor(Math.random()*20)
    escJogOrg = 0
    aprJog - 1 < 0 ? 0 : aprJog--
    enfJog - 1 < 0 ? 0 : enfJog--
    aprIni - 1 < 0 ? 0 : aprIni--
    ...
    permicao = false
    if (iniTurnoAc[0] < 10) {
        iniTurnoAc[1] = Math.floor(Math.random()*12+20)
    ...
    } else if (iniTurnoAc[0] < 13) {
        iniTurnoAc[1] = Math.floor(Math.random()*15+15)
        document.getElementById('ini-acao-img').src = 'Sprites/Batalha/escudo-bolota.png'
        document.getElementById('ini-acao').innerHTML = iniTurnoAc[1]
    } else if (iniTurnoAc[0] < 16) {
        iniTurnoAc[1] = ['buff', Math.floor(Math.random()*4+8)]
        ...
        iniTurnoAc[1] = ['debuff 1', Math.floor(Math.random()*4+7)]
...
var load = setInterval(() => {
    ...
    vidIniV = Math.floor(vidIniOrg/90*500)
    ...
    vidIniBol.innerHTML = Math.floor(vidIni/500*90)
