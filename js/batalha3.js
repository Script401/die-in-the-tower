...
function turnoJogador() {
    iniTurnoAc[0] = Math.floor(Math.random()*5)
    escJogOrg = 0
    aprJog - 1 < 0 ? 0 : aprJog--
    enfJog - 1 < 0 ? 0 : enfJog--
    aprIni - 1 < 0 ? 0 : aprIni--
    ...
    if (iniTurnoAc[0] == 0) {
        ...
        iniTurnoAc[1] = ['debuff 1', Math.floor(Math.random()*4+6)]
        document.getElementById('ini-acao').style.cssText = 'background-color: green;'
        document.getElementById('ini-acao').innerHTML = iniTurnoAc[1][0]
    } else if (iniTurnoAc[0] == 4) {
        iniTurnoAc[1] = ['debuff 2', Math.floor(Math.random()*3+3)]
        document.getElementById('ini-acao').style.cssText = 'background-color: green;'
        document.getElementById('ini-acao').innerHTML = iniTurnoAc[1][0]
    }
    addC = 5
...
var load = setInterval(() => {
    ...
    vidIniV = Math.floor(vidIniOrg/140*500)
    ...
    vidIniBol.innerHTML = Math.floor(vidIni/500*140)
